                ...
                alldata=data;
                    ...
                    if(textStatus == 'success') {
                        for(let i=0;i<data.data.length;i++){
                            ...
                            table_content +='<td data-value="datec">'+new Date(data_row["start_date"]).toISOString().slice(0, 19).replace("T"," ")+'</td>';
                            table_content +='<td data-value="datem">'+new Date(data_row["end_date"]).toISOString().slice(0, 19).replace("T"," ")+'</td>'; 
                ...
                var data = data[index];
                   ...
                   // if(data.length>0) {
                        var table_content='';
                            ...
                            table_content +='<td colspan="2" style="font-weight:bold;">'+new Date(data["start_date"]).toISOString().slice(0, 19).replace("T"," ")+'</td>';
                            table_content +='</tr>';
                            table_content +='<tr>';
                            table_content +='<td>End Date:</td>';
                            table_content +='<td colspan="2" style="font-weight:bold;">'+new Date(data["end_date"]).toISOString().slice(0, 19).replace("T"," ")+'</td>';
                            table_content +='</tr>';
                            table_content +='<tr>';
     ...
     function editData(id,obj){
        ...
        var data = data[index];
            ...
            for(i=0;i<data.question_set.length;i++){
                ...
                question_content +='<input type="hidden" class="_id" value="'+qrow['id']+'">';
