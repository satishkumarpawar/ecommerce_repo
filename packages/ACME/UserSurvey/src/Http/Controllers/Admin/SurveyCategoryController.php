...
namespace ACME\UserSurvey\Http\Controllers\Admin;
...
use ACME\UserSurvey\Contracts\Category;

class SurveyCategoryController extends Controller implements Category
{
