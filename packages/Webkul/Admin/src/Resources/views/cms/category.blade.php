...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="heading_text">Add Page Category</h4>
      </div>
      <div class="modal-body">
            ...
            <tr>
                ...
                <tr>
                <td>Hide in Menu:</td>
                <td colspan="2" style="font-weight:bold;"><select id="restrict"><option value="1">Yes</option><option value="0">No</option></select></td>
                </tr>
                <tr>
...
function getData(requestURL){
   ...
   if(requestURL=='')requestURL = "{{ url('/') }}/api/pages/category/get-list?token=true&limit=1000";
        ...
        console.log("get_page_categories : "+requestURL);
        ...
        var checkCall = $.ajax({
            ...
            success: function( data, textStatus, jQxhr ){
                alldata=data;
                    console.log("get_page_categories() data  : " + JSON.stringify(data));
            ...
            error: function( jqXhr, textStatus, errorThrown ){
                    console.log( "Error Thrown get_page_categories : "+errorThrown );
            }
        });
...
function deleteData(id){
   ...
   requestURL = "{{ url('/') }}/api/pages/category/delete?token=true&id="+id;
   var dt = $('#table_content').DataTable();
     ...
     function addData(obj){
        ...
        $("#heading_text").val("Add Page Category");
        $("#id").val("");
        $("#cate_name").val("");
        $("#cate_order").val("");
        $("#status").val(1);
     ...
     function editData(id,obj){
        ...
        var data = data[index];
            ...
            $("#heading_text").val("Edit Page Category");
            $("#id").val(data["id"]);
...
function saveData() {
    ...
    if($("#id").val()!="undefined" && $("#id").val()!=""){
        act="save";
        method="put";
        var data={"id":$("#id").val(),"cate_name":$("#cate_name").val(),"cate_desc":$("textarea#cate_desc").val(),"cate_order":$("#cate_order").val(),"status":$("#status").val(),"restrict":$("#restrict").val()};
        requestURL = "{{ url('/') }}/api/pages/category/update?token=true";
     } else {
        act="add";
        method="post";
        var data={"cate_name":$("#cate_name").val(),"cate_desc":$("textarea#cate_desc").val(),"cate_order":$("#cate_order").val(),"status":$("#status").val(),"restrict":$("#restrict").val()};
        requestURL = "{{ url('/') }}/api/pages/category/create?token=true";   
    }
